	...
	$.ajax({
		...
		success: function (result) {
			...
			if (result['error'] == false) {
				...
				if (result['data'][0].plan_image != "") {
					$("#plan_image_display").removeClass("d-none");
					$("#plan_image").attr("src", "assets/uploads/plan-image/" + result['data'][0].plan_image);
					console.log(result['data'][0]);
					$("#old_plan_image").val(result['data'][0].plan_image);

				}
				else {
					$("#plan_image_display").addClass("d-none");
				}
	...
	$.ajax({
		...
		success: function (result) {
			...
			if (result['error'] == false) {
				...
				$("#personal_referral_code").val(result['data'].personal_referral_code);
